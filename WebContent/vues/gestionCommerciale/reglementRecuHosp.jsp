...
{
	document.forms[0].dispatch.value = "afficherRecuHosp";
	document.forms[0].submit();
	
	document.forms[1].dispatch.value = "imprimerRecuHospRegle";
...
function afficherRecuCNAM()
{
	...
	document.forms[0].dispatch.value = "afficherRecuCNAMHosp";
	document.forms[0].submit();
...
function afficherRecuCNAMAvance()
{
	if (checkAvance())
	{
	document.forms[0].dispatch.value = "afficherRecuCNAMHosp";
...
function supprimerReglement(var1)
{
	...
	document.forms[0].idReglementAsupprimer.value=var1;
	   document.forms[0].dispatch.value="supprimerReglementHosp"; 
	   document.forms[0].submit(); 
}
		...
		{
			var aRendre=document.forms[0].aRendre;
			var rendu=document.forms[0].rendu;

			if (rendu.value=="")
			{
				couleurRouge(rendu);
				divRenduVide.style.display='block';
			    return false;
			}
			else if ( (parseInt(rendu.value) > (parseInt(aRendre.value))))
			{
				couleurRouge(rendu);
				divRendu.style.display='block';
			    return false;
			}
			else 
			{
		...
		function checkReglement()
		{
			...
			switch (id)
			{
				case '1':
					if (checkMontant())
					{
						document.forms[0].dispatch.value = "addReglementHosp";
						document.forms[0].submit();
					}	
...
<input type="hidden" name="aRendre" value="<bean:write name="formInfosPatient" property="aRendre" />"/>
...
<table  align="center" bgcolor="#00253E" style="color:#E70739; font-weight:bold;  font-size:16; margin-bottom: 5px;">
	...
	<tr bgcolor="white" align="left" id="divRenduVide" style="display: none">
	<td> Veuillez remplir le champ montant rendu  </td>
	</tr>
	<tr bgcolor="white" align="left" id="divRendu" style="display: none">
	<td> Montant rendu doit etre inferieur  à montant "A rendre"  </td>
	</tr>
				  ...
				  <tr  align="center">
				   ...
				   <tr  align="center">
					...
					<logic:notEqual name="formInfosPatient" property="recuRegle" value="0">
						<logic:equal name="formInfosPatient" property="aRendre" value="0">
						...
						<logic:notEqual name="formInfosPatient" property="aRendre" value="0">
						<table style="background:#00253E; font-size:14; font-weight:bold; color: white;">
							<tr>
							<td>A rendre</td>
							<td><bean:write name="formInfosPatient" property="aRendre" /></td>
							</tr>
							
							<tr>
							<td>Montant Rendu</td>
							<td>
							 <html:text styleClass="champText" property="rendu" onkeypress="Numerique();" styleId="rendu" onfocus="couleurBlanc(this,'divRendu'); couleurBlanc(this,'divRenduVide');"  size ="23"/>
							</td>
							</tr>
							...
							<td colspan="2">
							 <logic:notEqual name="formInfosPatient" property="libeleAssureur" value="CNAM">
							  <input type="button"   onclick="afficherRecuAvance();" value="Valider Réglement" size ="50" style="font-weight:bold; background-color:#00253E; color:#FFFFFF; cursor:hand; border:solid 2px #FF6600;"  />
							 </logic:notEqual>
							 
							 <logic:equal name="formInfosPatient" property="libeleAssureur" value="CNAM">
							   <input type="button"   onclick="afficherRecuCNAMAvance();" value="Valider Réglement" size ="50" style="font-weight:bold; background-color:#00253E; color:#FFFFFF; cursor:hand; border:solid 2px #FF6600;"  />
							 </logic:equal>
							</td>
							</tr>
						</table>
