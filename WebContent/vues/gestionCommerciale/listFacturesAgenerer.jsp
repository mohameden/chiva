...
function gnererFactureAssureur(var1)
{
	document.forms[0].factureId.value = var1;
	document.forms[0].dispatch.value = "genererFactureAssureur";
	document.forms[0].submit();
...
<font  style="oblique" color="#FF6600"  size="5">Facturation</font></td>
		  ...
		  <logic:equal name="formInfosPatient" property="isFirst" value="false">
		  <table width="100%"   align="center" style="background:#0B415F; ">
		  <tr><td>
		  <table width="100%" align="center" style="background:#00253E; font-size:14; font-weight:bold; color: white;">
		  <tr  align="center" style="background:#0B415F; border-left-color:#CBE4F4; border-left-style:solid;" >
            <td colspan="4" style="font-weight:bold"><font style="oblique" color="#FFFFFF"  size="4"> Factures à générer </font></td>
          </tr>
		  <tr align="center">
		   <td colspan="4" align="center">
		     <display:table id="row"  name="sessionScope.formInfosPatient.facturesAgenererList"  class="mars" pagesize="5" defaultsort="1" defaultorder="descending" >
		<display:setProperty name="paging.banner.placement" value="bottom"></display:setProperty>
		<display:setProperty name="css.tr.even" value="even"></display:setProperty>
		   	
				<display:column style=" text-decoration: underline;" title="générer facture">
					<a id="dialog_link" style="cursor: pointer" onclick="gnererFactureAssureur('<bean:write name="row" property="factureId"/>');">
