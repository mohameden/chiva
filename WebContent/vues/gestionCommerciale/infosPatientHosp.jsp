...
<script type="text/javascript">
  ...
  function checkDatesPC()
  {
   ...
   function checkChamps()
   {
     ...
     if (msg==false)
     {
	     document.forms[0].dispatch.value="savePatientForActesHosp"; 
   ...
   function ajouterPrestCouv()
   {
	   ...
	   document.forms[0].dispatch.value="construireListePrestCouvertesHosp"; 
	   document.forms[0].submit();
	   }
   }
    ...
    function choixActeParClasse()
    {
		...
		function rechercher ()
    	{
        	...
        	document.forms[0].dispatch.value = "chercherHosp";
        	document.forms[0].submit();
    	}
