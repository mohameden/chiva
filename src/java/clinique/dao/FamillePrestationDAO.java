...
public class FamillePrestationDAO implements ConstantesMetier {
	
	private static Logger log = Logger.getLogger(FamillePrestationDAO.class);
	private static final FamillePrestationDAO INSTANCE = new FamillePrestationDAO();

	public static FamillePrestationDAO getInstance() {
		  return INSTANCE;
		 }

	private FamillePrestationDAO () {}
	public FamillePrestation getFamillePrestation(int famillePrestationId)
	{
        ...
        try
        {
		     ...
		     famillePrestation = (FamillePrestation) session.get(FamillePrestation.class, famillePrestationId);
