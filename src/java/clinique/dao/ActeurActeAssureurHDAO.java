...
public class ActeurActeAssureurHDAO implements ConstantesMetier {
	
	private static Logger log = Logger.getLogger(ActeurActeAssureurHDAO.class);
	private static final ActeurActeAssureurHDAO INSTANCE = new ActeurActeAssureurHDAO();

	public static ActeurActeAssureurHDAO getInstance() {
		  return INSTANCE;
		 }

	private ActeurActeAssureurHDAO () {}
	public ActeurActeAssureurH getActeurActeAssureurH(String acteurActeAssureurHId)
	{
		     ...
		     acteurActeAssureurH = (ActeurActeAssureurH) session.get(ActeurActeAssureurH.class, acteurActeAssureurHId);
	...
	public ActeurActeAssureurH getActeurActeAssureurHByDate(Acteur acteur,Date date1,Acte acte,Categorie categorie)
	{
		     log.debug("********** Debut getActeurActeAssureurHByDate ActeurActeAssureurHDAO **********");
		     try
		     {
		    	 if (acteur!=null && date1!=null && acte!=null && categorie!=null)
		    	   {
			    	...
			    	strQuery+="where acteurActeAssureurH.acte.acteId = "+acte.getActeId();
			    	strQuery+=" and acteurActeAssureurH.acteur.acteurId = "+acteur.getActeurId();
			    	strQuery+=" and acteurActeAssureurH.categorie.categorieId = "+categorie.getCategorieId();
			    	strQuery+=" and acteurActeAssureurH.isException = "+STATUT_VALIDE;
			    	strQuery+=" and acteurActeAssureurH.statut = "+STATUT_VALIDE;
			    	strQuery+=" and acteurActeAssureurH.dateDebut <= '"+ dateFacture+"'";
			    	strQuery+=" and acteurActeAssureurH.dateFin >= '"+ dateFacture+"'";
	...
	public void updateActeurActeAssureurH(ActeurActeAssureurH acteurActeAssureurH)
	{
	...
	public void deleteActeurActeAssureurH(ActeurActeAssureurH acteurActeAssureurH)
	{
	...
	public List<ActeurActeAssureurH> listActeurActeAssureurHsActeurActeAssureurHurs() 
	{
		...
		try 
	    {
	    	...
	    	strQuery+="and acteurActeAssureurH.statut = "+STATUT_VALIDE;
	    	strQuery+=" and acteurActeAssureurHurActeurActeAssureurH.statut = "+STATUT_VALIDE;
