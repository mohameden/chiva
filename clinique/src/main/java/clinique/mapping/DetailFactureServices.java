...
public class DetailFactureServices extends Entity<DetailFactureServices> implements HasDetailFactureInfo {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3866749798483225170L;
	private String detailFactServiceId;
	...
	public int hashCode() {
		...
		result = prime * result
				+ (detailFactServiceId == null ? 0 : detailFactServiceId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		DetailFactureServices other = (DetailFactureServices) obj;
		if (acte == null) {
			if (other.acte != null) {
				return false;
			}
		...
		if (detailFactServiceId == null) {
			if (other.detailFactServiceId != null) {
				return false;
			}
		} else if (!detailFactServiceId.equals(other.detailFactServiceId)) {
			return false;
		}
		if (facture == null) {
	...
	@Override
	protected DetailFactureServices createEntity() {
		return new DetailFactureServices();
	}

	@Override
	public void updateWith(DetailFactureServices entity) {
		detailFactServiceId = entity.getDetailFactServiceId();
	...
	public String getDetailFactServiceId() {
		return detailFactServiceId;
	}

	public void setDetailFactServiceId(String detailFactServiceId) {
		this.detailFactServiceId = detailFactServiceId;
	}
