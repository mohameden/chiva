...
public class ActeAssureur extends Entity<ActeAssureur> {
	...
	@Override
	protected ActeAssureur createEntity() {
		return new ActeAssureur();
	}

	@Override
	public void updateWith(ActeAssureur entity) {
		acteAssureurId = entity.getActeAssureurId();
