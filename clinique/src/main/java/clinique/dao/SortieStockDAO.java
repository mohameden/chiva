...
@Repository
public class SortieStockDAO extends CliniqueHibernateDaoSupport<SortieStock> {
	...
	public SortieStock getSortieStock(int sortieStockId) {
		...
		try {
			...
			sortieStock = (SortieStock) session.get(SortieStock.class,
					sortieStockId);
			return sortieStock;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public SortieStock getSortieStockByProduitAndDateAndQuantite(int ProduitId,
			Date dateSortie, int quantite) {
