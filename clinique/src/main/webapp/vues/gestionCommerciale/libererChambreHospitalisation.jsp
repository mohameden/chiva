...
$(function() {
	...
	$("#dateSortie1").datepicker({yearRange: '2010:2030'});
...
function regler()
{
		if (!checkDateSortie())
		{
				...
				document.forms[0].dispatch.value = "libererChambre";
...
<td width="15%"></td>
		  ...
		  <td width="25%" style="color: #FF6600;">
		  <html:text styleClass="champText" property="dateSortie" onfocus="" onkeypress="effacer();"  styleId="dateSortie1" size ="23"/>
		  </td>
		  <td colspan="3"></td>
		  </tr>
		  <tr>
		  <td width="22%">Heure sortie</td>
		  <td width="25%" style="color: #FF6600;">
