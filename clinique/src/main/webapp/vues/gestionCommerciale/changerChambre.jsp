...
{
	   if (document.forms[0].dateEntreeChambre.value!="")
	     {
	      if(verifierDate(document.forms[0].dateEntreeChambre.value)==false)
	      {
...
$(function() {
	...
	$("#dateEntreeChambre").datepicker({yearRange: '2010:2030'});
...
function changerChambre()
{

		if (!checkDateEntree())
		{
		document.forms[0].dispatch.value = "changerChambre";
...
<td width="15%"></td>
		  ...
		  <td width="22%">Date entrée</td>
		  <td width="25%" style="color: #FF6600;">
		  <html:text styleClass="champText" property="dateEntreeChambre" onfocus="" onkeypress="effacer();"  styleId="dateEntreeChambre" size ="23"/>
		  </td>
		  <td colspan="3"></td>
		  </tr>
		  ...
		  <td colspan="5" align="center">  
		  		  <input type="button" onclick="changerChambre();" value="Changer" size ="50" style="font-weight:bold; background-color:#00253E; color:#FFFFFF; cursor:hand; border:solid 2px #FF6600;"  />
		  		  </td>
		  </tr>
