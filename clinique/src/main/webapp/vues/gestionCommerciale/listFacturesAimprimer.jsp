		...
		function checkChamps()
		   {
		     ...
		     if (msg==false)
		     {
			     document.forms[0].dispatch.value="listFacturesAimprimer"; 
...
function imprimerFacture(var1)
{
	
	//document.forms[0].dispatch.value = "imprimerFacture";
	//document.forms[0].submit();
...
<font  style="oblique" color="#FF6600"  size="5">Facturation</font></td>
		  ...
		  <td colspan="2"  align="center" style="background:#0B415F; ">
			  ...
			  <tr  align="center" style="background:#0B415F; border-left-color:#CBE4F4; border-left-style:solid;" >
	            <td colspan="4" style="font-weight:bold"><font style="oblique" color="#FFFFFF"  size="4"> Recherche facture </font></td>
	          </tr>
		  ...
		  <tr align="center">
		   <td colspan="4" align="center">
		     <display:table id="row"  name="sessionScope.formInfosPatient.facturesAimprimerList"  class="mars" pagesize="5" defaultsort="1" defaultorder="descending" >
		...
		<display:setProperty name="css.tr.even" value="even"></display:setProperty>
				...
				<display:column style=" text-decoration: underline;" title="Imprimer">
					<a id="dialog_link" style="cursor: pointer" onclick="imprimerFacture('<bean:write name="row" property="factureId"/>');">
					<img align="middle"    src="<%=request.getContextPath()%>/<bean:message key="image.print" />" />
					</a>
				</display:column>
		 	 
		 	<display:column  property="factureId" title="Num facture" sortProperty="nom"/>
