...
function FermerDivPrestation()
{
	...
	document.forms[0].dispatch.value = "ajouterActeDevis";
	document.forms[0].submit();
...
function supprimerActe(var1)
	    {
	    	document.forms[0].idPrestAsupprimer.value=var1;
	 	   document.forms[0].dispatch.value="supprimerPrestFromListeDevis"; 
	 	   document.forms[0].submit(); 
	    }

function valider()
{
	document.forms[0].dispatch.value = "creerDevis";
	document.forms[0].submit();
}
...
<td width="15%"></td>
  ...
  <display:table id="row"  name="sessionScope.formInfosPatient.devisActesList"  class="mars" pagesize="5" defaultsort="1" defaultorder="descending" >
		<display:setProperty name="paging.banner.placement" value="bottom"></display:setProperty>
		<display:setProperty name="css.tr.even" value="even"></display:setProperty>
		   

		 	
			<display:column  property="acte.nomActe" title="Acte" />
				
			<display:column  property="nbre" title="Nombre" />
			<display:column  property="prix" title="Prix" />
			<display:column  property="total" title="Total" />
			
			<display:column style=" text-decoration: underline;" title="Supprimer">
				<a  style="cursor: pointer" onclick="supprimerActe('<bean:write name="row" property="devisActesId"/>');">
				 <img align="middle" height="10" width="10"   src="<%=request.getContextPath()%>/<bean:message key="image.delete" />" />
		  		  ...
		  		  <logic:notEmpty name="formInfosPatient" property="devisActesList">
		  		   Total devis
		  		  </logic:notEmpty>
		  		  </td>
		  		  <td colspan="2" align="center">
		  		  <logic:notEmpty name="formInfosPatient" property="devisActesList">
		  		  <bean:write name="formInfosPatient" property="totalDevis"  />
		  		  </logic:notEmpty>
		  		  </td>
		  		  </tr>
		  		  ...
		  		  <logic:notEmpty name="formInfosPatient" property="devisActesList">
		  		  <input type="button" onclick="valider();" value="Valider" size ="50" style="font-weight:bold; background-color:#00253E; color:#FFFFFF; cursor:hand; border:solid 2px #FF6600;"  />
		  		 </logic:notEmpty>
		  		  </td>
		  		  </tr>
		  		  </table>
