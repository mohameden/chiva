...
function FermerDivPrestation()
{
	...
	document.forms[0].dispatch.value = "ajouterActeModificationFactureAssureur";
	document.forms[0].submit();
...
<input type="hidden" name="factureModifieeId" value="<bean:write name="formInfosPatient" property="factureModifieeId" />" />
...
<td width="15%"></td>
		  ...
		  <div id="formulPrest" style="display: none;">
		  <table width="100%" align="left" style="background:#00253E; font-size:14; font-weight:bold; color: white;">
		  <tr  align="center" style="background:#0B415F; border-left-color:#CBE4F4; border-left-style:solid;" >
		  ...
		  <input type="button" onclick="CacherDivPrestation();" value="Annuler" size ="50" style="font-weight:bold; background-color:#00253E; color:#FFFFFF; cursor:hand; border:solid 2px #FF6600;"  />
		  </td></tr>
  ...
  <display:table id="row"  name="sessionScope.formInfosPatient.detailsFactureModifieesList"  class="mars" pagesize="5" defaultsort="1" defaultorder="descending" >
		...
		<display:setProperty name="css.tr.even" value="even"></display:setProperty>
			...
			<display:column  property="montantTotal" title="Prix" />
		  		  ...
		  		  <logic:equal name="formInfosPatient" property="nomAssureur" value="CNAM">
		  		  </logic:equal>
		  		  </td>
		  		  </tr>
		  		  ...
		  		  <logic:notEmpty name="formInfosPatient" property="detailsFactureModifieesList">
			       ...
			       <html:optionsCollection name="formInfosPatient" property="drgCnamListe" label="label" value="value" />
		  		  ...
		  		  <td colspan="4" align="center">
		  		  <logic:notEmpty name="formInfosPatient" property="detailsFactureModifieesList">
		  		  <input type="button" onclick="regler();" value="Régler" size ="50" style="font-weight:bold; background-color:#00253E; color:#FFFFFF; cursor:hand; border:solid 2px #FF6600;"  />
		  		 </logic:notEmpty>
		  		  </td>
		  		  </tr>
