		...
		function checkChamps()
		   {
		     ...
		     if (msg==false)
		     {
			     document.forms[0].dispatch.value="listDevisAimprimer"; 
...
function imprimerDevis(var1)
{
	document.forms[0].devisAssureurId.value = var1;
	document.forms[0].dispatch.value = "imprimerDevis";
	document.forms[0].submit();
...
<input type="hidden" name="devisAssureurId" />
...
<table width="100%"   align="center" style="background:#00253E; ">   
		 <tr><td>
		  ...
		  <tr>
		 <td colspan="5">
<font  style="oblique" color="#FF6600"  size="5">Liste de devis</font></td>
		  ...
		  <tr>
		  <td colspan="2"  align="center" style="background:#0B415F; ">
			  ...
			  <tr  align="center" style="background:#0B415F; border-left-color:#CBE4F4; border-left-style:solid;" >
	            <td colspan="4" style="font-weight:bold"><font style="oblique" color="#FFFFFF"  size="4"> Recherche devis </font></td>
	          </tr>
		       ...
		       <td width="20%"></td>
		        ...
		        <td>
		        <html:text styleClass="champText" property="dateDebutRechFact" onkeypress="effacer();" styleId="dateDebutRechFact" size ="23"/>
		        </td>
		        <td width="20%"></td>
		       </tr>
		       <tr align="center">
		       <td width="20%"></td>
		        ...
		        <td>
		          <html:text styleClass="champText" property="dateFinRechFact" onkeypress="effacer();" styleId="dateFinRechFact" size ="23"/>
		        </td>
		        <td width="20%"></td>
		       </tr>
		       <tr align="center">
		       <td colspan="4">
		       <input type="button" onclick="checkChamps();" value="Rechercher" size ="50" 
		       style="font-weight:bold; background-color:#00253E; color:#FFFFFF; cursor:hand; border:solid 2px #FF6600;"  />
		       </td>
		       </tr>
		       </table>
		  ...
		  <table width="100%" align="center" style="background:#00253E; font-size:14; font-weight:bold; color: white;">
		  <tr  align="center" style="background:#0B415F; border-left-color:#CBE4F4; border-left-style:solid;" >
            <td colspan="4" style="font-weight:bold"><font style="oblique" color="#FFFFFF"  size="4">
             <logic:equal name="formInfosPatient" property="isFirst" value="true">
             Liste  devis d'ajourdhui
             </logic:equal>
             <logic:notEqual name="formInfosPatient" property="isFirst" value="true">
             Liste  devis
             </logic:notEqual>
             </font>
             </td>
		  ...
		  <tr align="center">
		   <td colspan="4" align="center">
		     <display:table id="row"  name="sessionScope.formInfosPatient.devisAimprimerList"  class="mars" pagesize="5" defaultsort="1" defaultorder="descending" >
		...
		<display:setProperty name="css.tr.even" value="even"></display:setProperty>
				...
				<display:column style=" text-decoration: underline;" title="Imprimer">
					<a id="dialog_link" style="cursor: pointer" onclick="imprimerDevis('<bean:write name="row" property="devisAssureurId"/>');">
					<img align="middle"    src="<%=request.getContextPath()%>/<bean:message key="image.print" />" />
					</a>
				</display:column>
		 	 
		 	<display:column  property="devisAssureurId" title="Num devis" sortProperty="devisAssureurId"/>
		 	<display:column property="dateDevis" title="date devis" format="{0,date,dd/MM/yyyy}"/>
