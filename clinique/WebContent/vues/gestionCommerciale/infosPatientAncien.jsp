		...
		$(function() {
			...
			$('#dialog').dialog({
				...
				buttons: {
					"Suivant": function() { 
						$(this).dialog("close"); 
						document.forms[0].dispatch.value = "ajouterPrestationsFormulaire";
			        	document.forms[0].submit();
					}, 
					"Annuler": function() { 
						$(this).dialog("close"); 
...
<td width="15%"></td>
		  ...
		  <td width="31%"><html:text styleClass="champText" property="telephone" onkeypress="Numerique();" onfocus="couleurBlanc(this,'ErrTelephone');" size ="23"/></td>
