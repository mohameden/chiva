...
<table width="60%"   align="center" cellpadding="10"  style="background:#00253E;">
 	  ...
 	  <tr style="background:#00253E;" align="center" >
			<td  align="center" >
			<span class="nvelleHosp">
			<a href="javascript:document.forms[0].dispatch.value='infosPatientHosp'; document.forms[0].submit();" />
			</span>
			</td>
		  ...
		  <tr style="background:#00253E;" align="center"  >
			<td  align="center" >
			<span class="listHosp">
			<a href="javascript:document.forms[0].dispatch.value='listHospitalises'; document.forms[0].submit();" ></a>
			</span>
			</td>
