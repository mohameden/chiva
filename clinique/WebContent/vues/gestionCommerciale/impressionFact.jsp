...
<table width="60%"   align="center" cellpadding="10"  style="background:#00253E;">
 	  ...
 	  <tr style="background:#00253E;" align="center" >
			<td  align="center" >
			<span class="ImpFact">
			<a href="javascript:document.forms[0].dispatch.value='listFacturesAimprimeAjourdhui'; document.forms[0].submit();" />
			</span>
			</td>
		  ...
		  <tr style="background:#00253E;" align="center"  >
		   ...
		   <tr style="background:#00253E;" align="center"  >
			<td  align="center" >
			<span class="ImpDevis">
			<a href="javascript:document.forms[0].dispatch.value='listDevisAimprimeAjourdhui'; document.forms[0].submit();" ></a>
			</span>
			</td>
