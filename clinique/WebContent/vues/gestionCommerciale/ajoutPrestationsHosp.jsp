...
function ouvrirPopUp()
{
    ...
    //document.forms[1].setAttribute('target', 'popup');
    //document.forms[1].setAttribute('onsubmit', '');
...
function regler()
{
	...
	document.forms[0].dispatch.value = "creerRecuHosp";
	document.forms[0].submit();


	document.forms[1].dispatch.value = "imprimerRecuHosp";
	document.forms[1].submit();
...
function FermerDivPrestation()
{
	...
	document.forms[0].dispatch.value = "ajouterActeForHosp";
	document.forms[0].submit();
  ...
  <display:table id="row"  name="sessionScope.formInfosPatient.detailsFactureList"  class="mars" pagesize="5" defaultsort="1" defaultorder="descending" >
		...
		<display:setProperty name="css.tr.even" value="even"></display:setProperty>
			...
			<display:column  property="montantTotal" title="Prix" />
		  		  ...
		  		  <input type="button" onclick="regler();" value="Valider et imprimer reçu" size ="50" style="font-weight:bold; background-color:#00253E; color:#FFFFFF; cursor:hand; border:solid 2px #FF6600;"  />
		  		 </logic:notEmpty>
		  		  </td>
		  		  </tr>
		  		 </table>
         ...
         <div id="dialog2" title="Information"  style="background:#00253E;" >
         </div>
