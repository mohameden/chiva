...
CREATE TABLE `tbl_detail_facture_chirurgie` (
  `detail_fact_chirurgie_id` varchar(20) NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (`detail_fact_chirurgie_id`),
  KEY `acte_id` (`acte_id`),
  KEY `recu_id` (`recu_id`),
...
ALTER TABLE `tbl_detail_facture_chirurgie`
ADD CONSTRAINT `tbl_detail_facture_chirurgie_ibfk_1` FOREIGN KEY (`detail_fact_id`) REFERENCES `tbl_detail_facture` (`detail_fact_id`);
